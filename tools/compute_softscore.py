...
def create_ans2label(occurence, name, processed_dir='data/processed'):
    ...
    cache_file = os.path.join(processed_dir, name + '_label2ans.pkl')
...
def load_cp():
    ...
    v2_val_answer_file = 'data/v2_mscoco_val2014_annotations.json'
    with open(v2_val_answer_file) as f:
        v2_val_answers = json.load(f)['annotations']
